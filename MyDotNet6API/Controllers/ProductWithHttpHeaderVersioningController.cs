...
/*
 * This controller is same with Product controller, here the only difference is the API version type 
 * in here I used the http header version for the API but in product controller its through route or url
 */
namespace MyDotNet6API.Controllers
{


    //https://localhost:7203/myproducts1?Page=1&Size=10
    //[Route("api/[controller]")]
    [ApiVersion("1.0")]
    //[Route("api/v{v:apiVersion}/[controller]")]
    [Route("myproducts1")]
    [ApiController]
    public class ProductWithHttpHeaderVersioningv1_0Controller : ControllerBase
    {
        private readonly ShopContext _context;

        public ProductWithHttpHeaderVersioningv1_0Controller(ShopContext context)
        {
            _context = context;
    ...
    //---API v2----------------//
    //https://localhost:7203/myproducts2?Page=1&Size=10
    [ApiVersion("2.0")]
    //[Route("api/v{v:apiVersion}/[controller]")]
    [Route("myproducts2")]
    [ApiController]
    public class ProductWithHttpHeaderVersioningV2_0Controller : ControllerBase
    {
        private readonly ShopContext _context;

        public ProductWithHttpHeaderVersioningV2_0Controller(ShopContext context)
        {
            _context = context;
            _context.Database.EnsureCreated();
        }
